            ...
            ElevenLabs: {
                Create: {
                    Form: {
                        ...
                        Email: {
                            NOT_PRESENT: 110, // Changed from 40
                            NOT_A_STRING: 111, // Changed from 41
                            INVALID_USERNAME: 112, // Changed from 42
                            INVALID_DOMAIN_NAME: 113, // Changed from 43
                            INVALID_EMAIL_CHARACTERS: 114, // Changed from 45
                            TOO_SHORT: 115, // Changed from 46
                            TOO_LONG: 116, // Changed from 47
                            FAILED_TO_VALIDATE_EMAIL: 117, // Changed from 44
                        },
                        Password: {
                            NOT_PRESENT: 118, // Changed from 54
                            NOT_A_STRING: 119, // Changed from 65
                            TOO_SHORT: 120, // Changed from 55
                            TOO_LONG: 121, // Changed from 56
                            MISSING_LOWERCASE: 122, // Changed from 57
                            MISSING_UPPERCASE: 123, // Changed from 58
                            MISSING_NUMBER: 124, // Changed from 59
                            MISSING_SPECIAL_CHARACTER: 125, // Changed from 63
                            FAILED_TO_VALIDATE_PASSWORD: 126, // Changed from 64
                        },
                    },
                    ElevenLabsAPI: {
                        UNPROCESSABLE_ENTITY: 9092,
                        INVALID_API_KEY: 9093,
                        UNKNOWN: 9094,
                    },
                    ACCOUNT_ID_ALREADY_EXISTS: 9096,
                },
                Update: {},
                Delete: {
                    Params: {
                        ID: {
                            ...
                            TOO_SHORT: 9791,
                            TOO_LONG: 9792,
                            INVALID_CHARACTER_FOUND: 9775,
                        },
                    },
                    ACCOUNT_ID_NOT_FOUND: 9331,
                },
                Get: {},
            },
        },
...
export const APIResponseCodeFlat = flatten(APIResCode);
export const APIResponsePhraseMap = invertObjectKV(flatten({ APIResCode }));
